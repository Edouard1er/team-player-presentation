...
const playersData = [
...

  {
    ...
    position: 'Defender', // Vous pouvez ajouter une position spécifique si nécessaire
    avatar: Eddy2, // Assurez-vous que Pilou est correctement importé
    avatar2: Eddy1, // Assurez-vous que Pilou est correctement importé
    detailText: (
      <div>
        <p>Meet the amazing coding guru, Chevenslove EDOUARD, who at the age of 25 (born on 06/02/1998) is making waves in the coding world.</p>
        <p>Hailing from the beautiful town of Leogane, Haiti, Chevenslove excels in JavaScript and React, leaving others in awe of his skills.</p>
        <p>However, even coding maestros have their kryptonite, and for Chevenslove, it's the enigmatic world of artificial intelligence. Despite this, he proudly boasts his greatest coding achievement: developing a Monitoring and Evaluation Platform for a consortium comprising ACF, HEIFER, and JWT. Bravo!</p>
        <p>When he's not crafting code, Chevenslove indulges in his passions for football and music. A man of many talents!</p>
      </div>
    ),
  },
  {
    ...
    position: 'Forwad', // Ajoutez une position spécifique si nécessaire
    avatar: Pilou1, // Assurez-vous que Pilou est correctement importé
    avatar2: Pilou2, // Assurez-vous que Pilou est correctement importé
    detailText: (
      <div>
        <p>Meet the extraordinary coder, Pierre-Louis SQUAGLIA, who, at the age of 22 (born on 14/11/2001), has left an indelible mark on the coding landscape.</p>
        <p>Originally hailing from Bastia, Corse, Pierre-Louis demonstrates unparalleled coding prowess in JavaScript and Angular, establishing himself as a force to be reckoned with.</p>
        <p>While his coding forte lies in the world of web technologies, he openly admits to being somewhat mystified by the intricacies of artificial intelligence. But, here's the twist: his most significant achievement in coding is proudly declaring "No Code." A true renegade!</p>
  ...
  },
  {
    ...
    detailText: (
      <div>
        <p>Meet the coding maestro, Toussaint CARLOTTI, who, at the age of 23 (born on 17/12/2000), has carved a niche in the coding world.</p>
  ...
  },
  {
    ...
    position: 'Defender',
    avatar: Dimitri2, // Assurez-vous que Pilou est correctement importé
    avatar2: Dimitri1, // Assurez-vous que Pilou est correctement importé
    detailText: (
      <div>
        <p>Meet the enigmatic coder, Dimitri Denis, aged 25 (born on 21/05/1998), who adds a unique flair to the coding community.</p>
        <p>Hailing from Tours, France, Dimitri specializes in the intricate world of Angular, showcasing his expertise in this sophisticated framework.</p>
